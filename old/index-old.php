...
<div class="container rubrique shadow mb-5">
	<div class="row">
		<div class="col-lg-4">
			<img src="images/mariage/thumbnail-mariage-ben-video.jpg" class="img-fluid" alt="">
			...
			<p><a class="float-right" href="mariage-ben-video.php" role="button">En savoir plus »</a></p>
		</div><!-- /.col-lg-4 -->
		<div class="col-lg-4">
			<img src="images/films_dentreprises/thumbnail-film-entreprises-ben-video.jpg" class="img-fluid" alt="">
			...
			<p><a class="float-right" href="films-entreprise-ben-video.php" role="button"> En savoir plus »</a></p>
		</div><!-- /.col-lg-4 -->
		<div class="col-lg-4">
			<img src="images/films_artistiques/thumbnail-film-artistique-ben-video.jpg" class="img-fluid" alt="">
			...
			<p><a class=" float-right" href="films-artistiques-ben-video.php" role="button"> En savoir plus »</a></p>
		</div><!-- /.col-lg-4 -->
	</div>
</div>
